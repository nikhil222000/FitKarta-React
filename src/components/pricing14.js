        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text165 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
            ...
            <p>
              {props.content2 ?? (
                <Fragment>
                  <p className="pricing14-text166 thq-body-large">
                    <span>
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text204 thq-heading-3">
                          $50/session
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  <span>
                    {props.plan21 ?? (
                      <Fragment>
                        <span className="pricing14-text199 thq-body-large">
                          Business plan
                        </span>
                      </Fragment>
                    )}
