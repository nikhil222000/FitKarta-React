                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text32 thq-body-small">
                      Choose a convenient time for your personalized fitness
                      training session.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Our certified personal trainer will arrive at your
                      doorstep with all the necessary equipment.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text27 thq-body-small">
                      Experience a tailored workout session designed to help you
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text26 thq-body-small">
                      Monitor your fitness journey and see the results of your
                      hard work.
                    </span>
                  </Fragment>
                )}
